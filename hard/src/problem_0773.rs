...
impl Config {
    pub fn from(initial_config: Vec<Vec<i32>>) -> Self {
        Self{
            board:[initial_config[0][0], initial_config[0][1], initial_config[0][2], initial_config[1][0], initial_config[1][1], initial_config[1][2]]
        }
    }
    ...
    pub fn is_end_config(&self) -> bool {
        self.board[0] == 1 && self.board[1] == 2 && self.board[2] == 3 && self.board[3] == 4 && self.board[4] == 5
    }
}
